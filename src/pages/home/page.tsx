...
const Page: React.FC<HomeProps> = ({ onIntroSeen }) => {
  const [notification, setNotification] = useState(false);
  const [introSeen, setIntroSeen] = useState<boolean>(false);

  const clickShowNotification = () => {
              ...
              <IonRow className="ion-justify-content-center ">
                <IonCol sizeSm="12" sizeMd="8" sizeLg="6" sizeXl="6">
                  ...
                  <div className='content'>
                    <div className='box-location'  onClick={() => window.location.href = '/pickppage'}>
                      ...
                      <div className='box-location-search'>
                        ...
                        <div className='bell' onClick={clickShowNotification}>
                  ...
                  {
                    notification && (
                      <div className='notification animate__animated animate__fadeInDown'>
                        <div className='notification-content'>
                          <div className='payment-unsuccessful'>
                            <div className='circleNotification n-Red'>
                              <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="1" y="1" width="20" height="16" rx="5" stroke="#F10000" stroke-opacity="0.5" stroke-width="1.5" />
                                <path d="M1 5.5H21" stroke="#F10000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M1 11.5H6" stroke="#F10000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>Payment Failed or Not Completed</div>
                              <div className='description'>We noticed that your payment was not completed or there was an error. Please try again or contact support for assistance.</div>
                            </div>
                          </div>
                          <div className='payment-successful'>
                            <div className='circleNotification n-green'>
                              <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="1" y="1" width="20" height="16" rx="5" stroke="#00E6B3" stroke-opacity="0.5" stroke-width="1.5" />
                                <path d="M1 5.5H21" stroke="#00E6B3" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M1 11.5H6" stroke="#00E6B3" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>Payment Failed or Not Completed</div>
                          ...
                          <div className='booking-successful'>
                            <div className='circleNotification n-green-car'>
                              <img src="/car2.png" alt="" />
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>Ride Booking Successful</div>
                              <div className='description'>Your ride has been successfully booked! Click here to view the details.</div>
                            </div>
                          </div>
                          <div className='booking-warnning'>
                            <div className='circleNotification n-yellow-car'>
                              <img src="/car2.png" alt="" />
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>Issue Encountered While En Route</div>
                              <div className='description'>We are currently on the way to pick you up and have encountered an issue. We appreciate your patience as we resolve this.</div>
                            </div>
                          </div>
                          <div className='booking-cancel'>
                            <div className='circleNotification n-red-car'>
                              <img src="/car2.png" alt="" />
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>Booking Unsuccessful</div>
                              <div className='description'>Unfortunately, your booking was not successful. Click here to view the details.</div>
                            </div>
                          </div>
                          <div>
                            <div className='circleNotification n-purple'>
                              <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 6.3706C15 4.65827 12.9884 3.73774 11.6926 4.85712L8.36317 7.73321C7.99988 8.04704 7.53583 8.21972 7.05576 8.21973L5.49998 8.21974C4.11928 8.21975 3 9.33903 3 10.7197V14.0127C3 15.3934 4.11929 16.5127 5.5 16.5127H7.0558C7.53587 16.5127 7.99993 16.6854 8.36322 16.9992L11.6926 19.8753C12.9884 20.9947 15 20.0741 15 18.3618V12.3662V6.3706Z" stroke="white" stroke-width="1.5" />
                              </svg>
                            </div>
                            <div className='circleNotification-text'>
                              <div className='title'>System Notification</div>
                              <div className='description'>This is a system-generated notification. Please check your account for updates.</div>
                            </div>
                          </div>
                        </div>
                      </div>
